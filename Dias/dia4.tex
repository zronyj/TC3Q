...
Si deseas profundizar m\'as en el uso de \LaTeX , ser\'ia recomendable que comenzaras otra vez desde el principio viendo en qu\'e var\'ian exactamente los diferentes tipos de documento. Luego pasar a ver casos especiales como rotaci\'on de una sola p\'agina, c\'omo utilizar colores en el texto, c\'omo incluir espacios en blanco, c\'omo trabajar con varias columnas, notas al pie, notas al margen, hiperv\'inculos, gr\'aficas autogeneradas, estructuras qu\'imicas autogeneradas, c\'omo lograr que algo se autonumere, etc. hasta terminar con programaci\'on y dise\~no de clases de documento o p\'aginas de estilo. Puedes llegar a hacer todo lo que te imaginas con esto.\\
