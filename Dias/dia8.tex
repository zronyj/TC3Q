...
Para comenzar, vamos a dejar claro que una de las ideas detr\'as de MC es igual a la de MM: hallar energ\'ias. Los programas de MC pueden utilizar los mismos algoritmos para hallar la conformaci\'on de m\'inima energ\'ia, por ejemplo. Pero el modelo para hallar la energ\'ia es distinto. Vamos a ver ahora c\'omo es que se prepara una mol\'ecula para un c\'alculo de minimizaci\'on, y c\'omo se ven los resultados.\\
