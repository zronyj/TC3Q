...
Finalmente, despu\'es de entender eso, vamos a volver a nuestra l\'inea de comando con nuestra base de datos nueva y en ella vamos a escribir \inlinecode{.read monitoreo.txt} Esto, en SQLite, lee todo el contenido del archivo y lo ejecuta. Puede que se tarde un momento, pero al final, la tabla de \textbf{Muestreo} no solo estar\'a creada, sino llena con toda la informaci\'on tambi\'en.
