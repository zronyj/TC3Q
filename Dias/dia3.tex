...
Lo que git nos dice ahora es que hay nuevos archivos que no han sido agregados al registro. Esto significa que s\'i son parte del proyecto, pero git no sabe si debe de registrarlos y \emph{seguirlos}. Inmediatamente se nos dice tambi\'e c\'omo se agregan estos al registro: \inlinecode{git add \emph{nombre\_del\_archivo.ext}}.
